package io.github.turingcstc.nebula.config.liquibase;
...
import static io.github.turingcstc.nebula.config.NebulaConstants.*;
...
public class AsyncSpringLiquibase extends SpringLiquibase {
  ...
  public static final String STARTING_ASYNC_MESSAGE =
      "Starting Liquibase asynchronoussetContextsly, your database might not be ready at startup!";
  ...
  public void afterPropertiesSet() throws LiquibaseException {
    if (!env.acceptsProfiles(Profiles.of(SPRING_PROFILE_NO_LIQUIBASE))) {
      if (env.acceptsProfiles(
          Profiles.of(SPRING_PROFILE_DEVELOPMENT + "|" + SPRING_PROFILE_HEROKU))) {
