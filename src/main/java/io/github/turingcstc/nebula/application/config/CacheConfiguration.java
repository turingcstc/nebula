...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, io.github.turingcstc.nebula.application.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, io.github.turingcstc.nebula.application.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, io.github.turingcstc.nebula.application.domain.User.class.getName());
            createCache(cm, io.github.turingcstc.nebula.application.domain.Authority.class.getName());
            createCache(cm, io.github.turingcstc.nebula.application.domain.User.class.getName() + ".authorities");
